...
con la parte de la aplicación móvil (app) de un sistema o servicio. Su principal objetivo es llevar 
un registro de actividades, errores y eventos importantes que ocurren en la aplicación móvil. 
...
el tipo de evento, la versión de la aplicación, el dispositivo utilizado y una descripción detallada 
del evento.
...
Auditoría y Monitoreo: Los registros generados por este script son esenciales para la auditoría de 
