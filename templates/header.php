...
El archivo header.php es la parte inicial de un documento HTML y se encarga de definir el encabezado de la 
página web. Este archivo header.php proporciona la estructura básica del encabezado de una página web e 
incluye otros elementos como hojas de estilo CSS, enlaces a scripts JavaScript y otros recursos necesarios 
para la presentación y funcionalidad de la página web.
